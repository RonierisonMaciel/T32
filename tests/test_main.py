...
def test_get_task():
    add_task(Task(id=1, title="Test Task", description="This is a test", completed=False, priority=1))  # Certifique-se de adicionar a tarefa
...
def test_update_task():
    ...
    updated_task_result = update_task(1, updated_task)
    
    assert updated_task_result == updated_task, f"Esperado: {updated_task}, mas foi: {updated_task_result}"

def test_delete_task():
    add_task(Task(id=1, title="Test Task", description="This is a test", completed=False, priority=1))  # Adiciona a tarefa
